...
const INITIAL_RESTAURANTS = [
  ...
  { id: 5, title: "หมูกระทะบุฟเฟต์", img: "public/restaurants/5/5.png", fallbackImg: "https://picsum.photos/seed/thaibbq/600/800", rating: "4.6", price: "฿฿", desc: "อิ่มไม่อั้นกับหมูกระทะเตาถ่าน หมูหมักนุ่มๆ สามชั้นสไลด์ และของทานเล่นเพียบ น้ำจิ้มสุกี้รสเด็ด เติมของตลอดไม่มีกั๊ก", tags: ["บุฟเฟต์", "ปิ้งย่าง"], time: "16:00 - 24:00 น.", videoUrl: "" },
  { id: 6, title: "ยำแซ่บซี๊ด", img: "public/restaurants/6/6.png", fallbackImg: "https://picsum.photos/seed/spicysalad/600/800", rating: "4.8", price: "฿฿", desc: "ยำรสแซ่บจัดจ้าน ปลาร้านัวๆ เครื่องแน่นทั้งกุ้งสด หมูยอ ไข่แดงเค็ม เลือกระดับความเผ็ดได้ตามใจชอบ", tags: ["ยำ", "รสจัด"], time: "11:00 - 21:00 น.", videoUrl: "" },
  { id: 7, title: "คาเฟ่ขนมหวาน", img: "public/restaurants/7/7.png", fallbackImg: "https://picsum.photos/seed/cafe/600/800", rating: "4.9", price: "฿฿", desc: "คาเฟ่สไตล์มินิมอล มีทั้งเค้ก บิงซู และเครื่องดื่มหลากหลาย มุมถ่ายรูปเพียบ เหมาะสำหรับมานั่งอ่านหนังสือหรือคุยงาน", tags: ["คาเฟ่", "ของหวาน"], time: "10:00 - 20:00 น.", videoUrl: "" },
  { id: 8, title: "อาหารตามสั่งป้าสม", img: "public/restaurants/8/8.png", fallbackImg: "https://picsum.photos/seed/thaifood/600/800", rating: "4.5", price: "฿", desc: "ร้านอาหารตามสั่งเจ้าเด็ด ข้าวกะเพราหมูกรอบไข่ดาวเยิ้มๆ ให้เยอะจุใจ รสชาติเข้มข้น ราคาเป็นมิตรกับนักศึกษา", tags: ["ตามสั่ง", "จานด่วน"], time: "08:00 - 18:00 น.", videoUrl: "" },
  { id: 9, title: "ชาบูหม้อไฟ", img: "public/restaurants/9/9.png", fallbackImg: "https://picsum.photos/seed/shabu/600/800", rating: "4.7", price: "฿฿฿", desc: "ชาบูน้ำซุปเข้มข้น เนื้อสไลด์พรีเมียม หมูคุโรบูตะ พร้อมน้ำจิ้มพอนสึและสุกี้ มีทั้งแบบ A La Carte และ Buffet", tags: ["ชาบู", "หม้อไฟ"], time: "11:00 - 22:00 น.", videoUrl: "" },
